  ...
  return (
    <div className={style.text}>
      ...
      <div className={style.text2}>
        ...
        ИП Мосенков Данил Вадимович (далее — Оператор). 1.1. Оператор ставит
        ...
        посетителях веб-сайта . 2. Основные понятия, используемые в Политике
        ...
        Пользователю веб-сайта https://onmyfeet.ru/. 2.9. Персональные данные,
        ...
        2.10. Пользователь — любой посетитель веб-сайта https://onmyfeet.ru/.
        ...
        Цель обработкиуточнение деталей заказаПерсональные данныефамилия, имя,
        отчество электронный адрес номера телефонов никнейм в мессенджере
        «Telegram» Правовые основанияФедеральный закон «Об информации,
        информационных технологиях и о защите информации» от 27.07.2006 N 149-ФЗ
        Виды обработки персональных данныхОтправка информационных писем на адрес
        ...
        уведомление на адрес электронной почты Оператора onmyfeet@yandex.ru с
        ...
        Оператора onmyfeet@yandex.ru с пометкой «Отзыв согласия на обработку
        ...
        onmyfeet@yandex.ru. 12.2. В данном документе будут отражены любые
